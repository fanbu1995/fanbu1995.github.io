...
\name{Fan Bu} % Your name
% \address{4 place Jussieu,
% Boite Courrier 247,
% 75252 Paris Cedex 5
% } % 
% \address{haowen.zhang@imj-prg.fr} % 
%\address{(+1) 919-638-1351} % Your phone number and email
\address{fanbu@ucla.edu}
\address{https://fanbu1995.github.io}
%\address{https://sites.google.com/view/fan-bu} % use this one for now, before updating the github website
...
Bayesian statistics and statistical computation for complex and large-scale datasets; stochastic processes and dynamic models; health data science and informatics; computational social science. %With applications in observational health data analysis, infectious disease modeling, social sciences, and sports analytics.
...
Bayesian Safety Surveillance with Adaptive Bias Correction (2023). \emph{Under revisions. arXiv:2305.12034} $^\dagger$
...
% \textbf{Fan Bu}, Oliver Ratmann, and Jason Xu (2022+). Uncovering HIV Transmission Flows Between Age Groups From Viral Deep-sequencing Data with Hierarchical Spatial Poisson Processes. \emph{Manuscript available upon request}

% \smallskip


% Raquel Asencio, \textbf{Fan Bu}, Liann Tucker, Gabriel Varela, James Moody, and Alexander Volfovsky (2022+). 
% Network Position and Emergent Phenomena: A Multi-team System Case Study (2022+). \emph{Under revisions.}

% \smallskip

%Martijn Schuemie, \textbf{Fan Bu}, Akihiko Nishimura and Marc Suchard (2022+). 
